  ...
  return (
    <main className="grid min-h-screen grid-cols-2">
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover px-28 py-16">
        ...
        <a
          href=""
          className="flex h-10 w-full items-center gap-3 text-left transition-colors hover:text-gray-50"
        >
        ...
        <div className="flex flex-col items-start justify-center gap-5">
          ...
          <a
            href=""
            className="rounded-full bg-green-500 px-5 py-3 font-alt text-sm font-bold text-gray-800 transition-colors hover:bg-green-400"
          >
            CADASTRAR LEMBRANÇA
          </a>
        </div>
